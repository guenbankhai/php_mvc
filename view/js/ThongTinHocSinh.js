...
document.getElementById('edit').addEventListener('click', function() {
    ...
    const namNhapHoc = selectedRow.cells[6].innerText.trim();
    const maLop = selectedRow.cells[7].innerText.trim();


    // Đặt giá trị cho các trường trong form #addForm
    document.getElementById('updatemaHS').value = maHS;
    ...
    document.getElementById('updatenamNhapHoc').value = namNhapHoc;
    document.getElementById('updatemaLop').value = maLop;
